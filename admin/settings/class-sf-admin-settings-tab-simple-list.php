...
class SharedFilesSettingsTabSimpleList {
  ...
  public function init() {
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-' . $only_pro . 'simple_list_show_search_filters', 'field_name' => $only_pro . 'simple_list_show_search_filters')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-simple_list_show_titles_for_columns', 'field_name' =>  'simple_list_show_titles_for_columns')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-simple_list_hide_file_description', 'field_name' =>  'simple_list_hide_file_description')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-simple_list_title_file', 'field_name' => 'simple_list_title_file')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-simple_list_show_download_counter', 'field_name' => 'simple_list_show_download_counter')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-simple_list_title_download_counter', 'field_name' => 'simple_list_title_download_counter', 'placeholder' => sanitize_text_field( __('Downloads', 'shared-files') ) )
    );
    ...
    for ($n = 1; $n < $custom_fields_cnt; $n++) {
      ...
      add_settings_field(
        ...
        'shared-files',
        'shared-files_tab_' . $tab,
        array('label_for' => 'shared-files-' . $only_pro . 'simple_list_show_custom_field_' . $n, 'field_name' => $only_pro . 'simple_list_show_custom_field_' . $n)
      );
      ...
      add_settings_field(
        ...
        'shared-files',
        'shared-files_tab_' . $tab,
        array('label_for' => 'shared-files-' . $only_pro . 'simple_list_title_custom_field_' . $n, 'field_name' => $only_pro . 'simple_list_title_custom_field_' . $n)
      );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-' . $only_pro . 'simple_list_show_category', 'field_name' => $only_pro . 'simple_list_show_category')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-' . $only_pro . 'simple_list_title_category', 'field_name' => $only_pro . 'simple_list_title_category')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-simple_list_show_tag', 'field_name' => 'simple_list_show_tag')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-simple_list_title_tag', 'field_name' => 'simple_list_title_tag', 'placeholder' => sanitize_text_field( __('Tag', 'shared-files') ))
    );
