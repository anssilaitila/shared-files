  ...
  public function init( $slug ) {
    ...
    if ( $single_file_free ) {
      ...
      add_settings_field(
        ...
        'shared-files',
        'shared-files_tab_' . $tab,
        array('label_for' => 'shared-files-' . $only_pro . 'single_file_show_custom_fields', 'field_name' => $only_pro . 'single_file_show_custom_fields')
      );
      ...
      add_settings_field(
        ...
        'shared-files',
        'shared-files_tab_' . $tab,
        array('label_for' => 'shared-files-' . $only_pro . 'single_file_show_description', 'field_name' => $only_pro . 'single_file_show_description')
      );
