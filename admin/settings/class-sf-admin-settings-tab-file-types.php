...
class SharedFilesSettingsTabFileTypes {
  ...
  public function init() {
    ...
    $file_exts = ['webp', 'avif', 'svg', 'json', 'csv', 'ttf', 'woff', 'woff2'];
    ...
    foreach ( $file_exts as $ext) {
      ...
      add_settings_field(
        ...
        'shared-files',
        'shared-files_tab_' . $tab,
        array('label_for' => 'shared-files-allow_file_type_' . $ext, 'field_name' => 'allow_file_type_' . $ext)
      );
    ...
    for ($n = 1; $n < $custom_file_types_cnt; $n++) {
      ...
      add_settings_field(
        ...
        'shared-files',
        'shared-files_tab_' . $tab,
        array('label_for' => 'shared-files-cft_' . $n . '_active', 'field_name' => 'cft_' . $n . '_active')
      );
      ...
      add_settings_field(
        ...
        'shared-files',
        'shared-files_tab_' . $tab,
        array('label_for' => 'shared-files-cft_' . $n . '_extension', 'field_name' => 'cft_' . $n . '_extension', 'placeholder' => '.ext')
      );
      ...
      add_settings_field(
        ...
        'shared-files',
        'shared-files_tab_' . $tab,
        array('label_for' => 'shared-files-cft_' . $n . '_mime_type', 'field_name' => 'cft_' . $n . '_mime_type')
      );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-custom_file_types_cnt', 'field_name' => 'custom_file_types_cnt', 'placeholder' => '')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-' . $only_pro . 'folder_icon_uri', 'field_name' => $only_pro . 'folder_icon_uri')
    );
