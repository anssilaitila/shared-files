...
class Shared_Files {
  ...
  private function define_admin_hooks() {
    ...
    $this->loader->add_action('manage_shared_file_posts_custom_column', $plugin_admin, 'shared_file_custom_columns_content', 10, 2);
    ...
    $this->loader->add_action('init', $plugin_admin, 'create_shared_files_custom_taxonomy', 0);

    if (sf_fs()->is__premium_only() && 0) {
      // ...
    } else {
    ...
    $this->loader->add_filter('manage_shared_file_posts_columns', $plugin_admin, 'shared_file_custom_columns', 10);
  }
