...
class SharedFilesHelpers {
  ...
  public static function getPreviewButton($file_id, $file_url, $atts = []) {
    ...
    if (
        isset( $s['hide_preview_button'] ) ||
        ( $password && $enable_preview_with_password == 0 ) ||
        ( $file_access_logged_in_only && $file_access_logged_in_only_enable_preview == 0 ) ||
    ...
    $pdf_types = array('application/msword',
      'application/pdf',
    ...
    if (in_array($filetype, $image_types)) {
      ...
      if ( $password && $enable_preview_with_password ) {
        ...
        isset( $s['always_preview_pdf'] ) &&
        !$password &&
        !$file_access_logged_in_only &&
        in_array( $filetype, $pdf_types )
    ) {
  ...
  public static function addFeaturedImage($file_id, $upload, $uploaded_type, $filename, $copy_to_media_library = 0) {
