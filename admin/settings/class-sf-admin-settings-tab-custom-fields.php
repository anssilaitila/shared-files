...
class SharedFilesSettingsTab4Content {
  ...
  public function init() {
    ...
    for ($n = 1; $n < $custom_fields_cnt; $n++) {
      ...
      if ( $n == 1 ) {
        ...
        add_settings_field(
          ...
          'shared-files',
          'shared-files_tab_' . $tab,
          array('label_for' => 'shared-files-file_upload_custom_field_' . $n, 'field_name' => 'file_upload_custom_field_' . $n, 'placeholder' => '')
        );
        ...
        add_settings_field(
          ...
          'shared-files',
          'shared-files_tab_' . $tab,
          array('label_for' => 'shared-files-' . $only_pro . 'file_upload_custom_field_' . $n, 'field_name' => $only_pro . 'file_upload_custom_field_' . $n, 'placeholder' => '', 'class' => 'shared-files-border-top')
        );
      ...
      add_settings_field(
        ...
        'shared-files',
        'shared-files_tab_' . $tab,
        array('label_for' => 'shared-files-' . $only_pro . 'cf_' . $n . '_use_as_search_filter', 'field_name' => $only_pro . 'cf_' . $n . '_use_as_search_filter')
      );
      ...
      add_settings_field(
        ...
        'shared-files',
        'shared-files_tab_' . $tab,
        array('label_for' => 'shared-files-' . $only_pro . 'cf_' . $n . '_select_title', 'field_name' => $only_pro . 'cf_' . $n . '_select_title')
      );
      ...
      add_settings_field(
        ...
        'shared-files',
        'shared-files_tab_' . $tab,
        array('label_for' => 'shared-files-' . $only_pro . 'cf_' . $n . '_hide_from_frontend_uploader', 'field_name' => $only_pro . 'cf_' . $n . '_hide_from_frontend_uploader')
      );
      ...
      add_settings_field(
        ...
        'shared-files',
        'shared-files_tab_' . $tab,
        array('label_for' => 'shared-files-' . $only_pro . 'cf_' . $n . '_hide_from_admin_edit', 'field_name' => $only_pro . 'cf_' . $n . '_hide_from_admin_edit', 'class' => 'shared-files-padding-bottom')
      );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-' . $only_pro . 'custom_fields_cnt', 'field_name' => $only_pro . 'custom_fields_cnt', 'placeholder' => '', 'class' => 'shared-files-border-top')
    );
