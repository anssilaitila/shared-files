...
class SharedFilesSettingsTabSearchLog {
    public function init( $slug ) {
        ...
        add_settings_field(
            ...
            'shared-files_tab_' . $tab,
            array(
                'label_for'  => 'shared-files-enable_search_log',
        ...
        add_settings_field(
            ...
            'shared-files_tab_' . $tab,
            array(
                'label_for'  => 'shared-files-esl_search_term',
        ...
        add_settings_field(
            ...
            'shared-files_tab_' . $tab,
            array(
                'label_for'   => 'shared-files-esl_search_term_min_chars',
        ...
        add_settings_field(
            ...
            'shared-files_tab_' . $tab,
            array(
                'label_for'  => 'shared-files-' . $only_pro . 'esl_user_ip',
        ...
        add_settings_field(
            ...
            'shared-files_tab_' . $tab,
            array(
                'label_for'  => 'shared-files-' . $only_pro . 'esl_user_country',
        ...
        add_settings_field(
            ...
            'shared-files_tab_' . $tab,
            array(
                'label_for'  => 'shared-files-' . $only_pro . 'esl_search_container',
        ...
        add_settings_field(
            ...
            'shared-files_tab_' . $tab,
            array(
                'label_for'  => 'shared-files-esl_user_agent',
        ...
        add_settings_field(
            ...
            'shared-files_tab_' . $tab,
            array(
                'label_for'  => 'shared-files-' . $only_pro . 'esl_referer_url',
