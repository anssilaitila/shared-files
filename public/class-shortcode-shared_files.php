    ...
    if (isset($atts['file_id'])) {
      ...
      if ($wpb_all_query->have_posts()):
        while ($wpb_all_query->have_posts()): $wpb_all_query->the_post();
          ...
          if ( isset($atts['layout']) && $atts['layout'] == 'minimal' ) {
            $html .= SharedFilesPublicFileCardMinimal::fileListItem($c, $imagefile, $hide_description, 2, $atts);
          } else {
            $html .= SharedFilesPublicFileCardDefault::fileListItem($c, $imagefile, $hide_description, 2, $atts);
          }
      ...
      if (isset($wpb_all_query_all_files) && $wpb_all_query_all_files->have_posts()):
        ...
        if ( isset($atts['hide_files_first']) ):
          ...
          while ($wpb_all_query->have_posts()): $wpb_all_query->the_post();
            ...
            if (isset($atts['file_upload'])) {
              $html .= SharedFilesPublicFileCardDefault::fileListItem($c, $imagefile, $hide_description, 1, $atts);
            } elseif (isset($atts['category'])) {
              $html .= SharedFilesPublicFileCardDefault::fileListItem($c, $imagefile, $hide_description, 0, $atts);
            } else {
              $html .= SharedFilesPublicFileCardDefault::fileListItem($c, $imagefile, $hide_description, 1, $atts);
            }
      ...
      if (!isset($s['hide_search_form']) && !isset($atts['hide_search_for_all_files'])) {
        ...
        if (isset($wpb_all_query_all_files) && $wpb_all_query_all_files->have_posts()):
          while ($wpb_all_query_all_files->have_posts()): $wpb_all_query_all_files->the_post();
            ...
            $html .= SharedFilesPublicFileCardDefault::fileListItem($c, $imagefile, $hide_description, $show_tags, $atts);
