...
class SharedFilesSettingsTabFileEdit {
  ...
  public function init() {
    ...
    foreach ($roles as $key => $value) {
      ...
      if ($key && $value) {
        ...
        add_settings_field(
          ...
          'shared-files',
          'shared-files_tab_' . $tab,
          array('label_for' => 'shared-files-' . $only_pro . 'can_edit_files_' . $key, 'field_name' => $only_pro . 'can_edit_files_' . $key, 'placeholder' => '')
        );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_10_2',
      array('label_for' => 'shared-files-' . $only_pro . 'file_edit_hide_external_url', 'field_name' => $only_pro . 'file_edit_hide_external_url')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_10_2',
      array('label_for' => 'shared-files-' . $only_pro . 'file_edit_hide_category_checkboxes', 'field_name' => $only_pro . 'file_edit_hide_category_checkboxes')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_10_2',
      array('label_for' => 'shared-files-' . $only_pro . 'file_edit_hide_new_categories', 'field_name' => $only_pro . 'file_edit_hide_new_categories')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_10_2',
      array('label_for' => 'shared-files-' . $only_pro . 'file_edit_hide_tag_checkboxes', 'field_name' => $only_pro . 'file_edit_hide_tag_checkboxes')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_10_2',
      array('label_for' => 'shared-files-' . $only_pro . 'file_edit_hide_new_tags', 'field_name' => $only_pro . 'file_edit_hide_new_tags')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_10_2',
      array('label_for' => 'shared-files-' . $only_pro . 'file_edit_hide_description', 'field_name' => $only_pro . 'file_edit_hide_description')
    );
