...
class SharedFilesSettingsTabExactSearch {
  ...
  public function init( $slug ) {
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-' . $only_pro . 'exact_search_min_chars', 'field_name' => $only_pro . 'exact_search_min_chars', 'placeholder' => 3)
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-' . $only_pro . 'exact_search_whole_words_only', 'field_name' => $only_pro . 'exact_search_whole_words_only')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-' . $only_pro . 'exact_search_ignore_file_extension', 'field_name' => $only_pro . 'exact_search_ignore_file_extension')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-' . $only_pro . 'exact_search_more_fields', 'field_name' => $only_pro . 'exact_search_more_fields')
    );
    ...
    for ($n = 1; $n < $custom_fields_cnt; $n++) {
      ...
      add_settings_field(
        ...
        'shared-files',
        'shared-files_tab_' . $tab,
        array('label_for' => 'shared-files-' . $only_pro . 'exact_search_custom_field_' . $n, 'field_name' => $only_pro . 'exact_search_custom_field_' . $n)
      );
