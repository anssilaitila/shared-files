...
class SharedFilesSettingsTab1Content {
  ...
  public function init() {
    ...
    add_settings_field(
      ...
      array('label_for' => 'shared-files-show_download_counter', 'field_name' => 'show_download_counter')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-download_counter_text', 'field_name' => 'download_counter_text', 'placeholder' => sanitize_text_field( __('Downloads:', 'shared-files') ) )
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-hide_search_form', 'field_name' => 'hide_search_form', 'placeholder' => sanitize_text_field( __('The search form is automatically visible unless hidden by this setting or by a shortcode parameter.', 'shared-files') ) )
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'search_input_targets_active_files', 'field_name' => $only_pro . 'search_input_targets_active_files', 'class' => 'shared-files-padding-bottom')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'file_access_logged_in_only', 'field_name' => $only_pro . 'file_access_logged_in_only', 'class' => 'shared-files-border-top')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'file_access_logged_in_only_show_featured_image', 'field_name' => $only_pro . 'file_access_logged_in_only_show_featured_image')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'file_access_logged_in_only_enable_preview', 'field_name' => $only_pro . 'file_access_logged_in_only_enable_preview', 'class' => 'shared-files-border-bottom')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-log_enable_user_data', 'field_name' => 'log_enable_user_data', 'class' => 'shared-files-padding-top' )
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-log_enable_ip', 'field_name' => 'log_enable_ip' )
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'log_enable_country', 'field_name' => $only_pro . 'log_enable_country', 'class' => 'shared-files-new-feature')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'log_enable_city', 'field_name' => $only_pro . 'log_enable_city', 'class' => 'shared-files-new-feature')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'log_enable_country_logging', 'field_name' => $only_pro . 'log_enable_country_logging', 'class' => 'shared-files-new-feature')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-log_enable_user_agent', 'field_name' => 'log_enable_user_agent' )
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-log_enable_referer_url', 'field_name' => 'log_enable_referer_url' )
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-show_tag_dropdown', 'field_name' => 'show_tag_dropdown')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'sort_tags_by', 'field_name' => $only_pro . 'sort_tags_by')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'show_category_dropdown', 'field_name' => $only_pro . 'show_category_dropdown')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'sort_categories_by', 'field_name' => $only_pro . 'sort_categories_by')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'pagination', 'field_name' => $only_pro . 'pagination', 'placeholder' => '20')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-always_preview_pdf', 'field_name' => 'always_preview_pdf')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-bypass_preview_pdf', 'field_name' => 'bypass_preview_pdf')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-folder_for_new_files', 'field_name' => 'folder_for_new_files', 'placeholder' => 'folder-name')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'enable_preview_for_password_protected_files', 'field_name' => $only_pro . 'enable_preview_for_password_protected_files')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'default_expiration_date', 'field_name' => $only_pro . 'default_expiration_date')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'delete_expired_files', 'field_name' => $only_pro . 'delete_expired_files')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'order_by_category_list', 'field_name' => $only_pro . 'order_by_category_list')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-maximum_size_text', 'field_name' => 'maximum_size_text', 'placeholder' => sanitize_text_field( SharedFilesHelpers::maxUploadSize() ) )
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'show_limit_message_on_file_card', 'field_name' => $only_pro . 'show_limit_message_on_file_card')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'download_limit_msg', 'field_name' => $only_pro . 'download_limit_msg', 'placeholder' => sanitize_text_field( __('This file is no longer available for download.', 'shared-files') ) )
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-disable_download_log', 'field_name' => 'disable_download_log')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-' . $only_pro . 'and_or_include_children', 'field_name' => $only_pro . 'and_or_include_children')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_section_general',
      array('label_for' => 'shared-files-disable_download_attr', 'field_name' => 'disable_download_attr')
    );
