      ...
      <div class="shared-files-admin-toolbar">
        ...
        <div class="shared-files-admin-toolbar-left">
          ...
          <div class="shared-files-admin-toolbar-left-plugin-title">
            ...
            <span class="shared-files-admin-toolbar-plugin-title">
              <?php echo esc_html__( 'Shared Files', 'shared-files' ); ?>
            </span>

            <span class="shared-files-admin-plan-small">FREE</span>

          </div>

          <div class="shared-files-admin-toolbar-left-links">

            <a href="<?php echo esc_url_raw( get_admin_url(null, './edit.php?post_type=shared_file') ) ?>"><?php echo esc_html__('All files', 'shared-files'); ?></a>
            <a href="<?php echo esc_url_raw( get_admin_url(null, './post-new.php?post_type=shared_file') ) ?>"><?php echo esc_html__('Add new file', 'shared-files'); ?></a>
            <a href="<?php echo esc_url_raw( get_admin_url(null, './edit-tags.php?taxonomy=' . SHARED_FILES_TAG_SLUG . '&post_type=shared_file') ) ?>"><?php echo esc_html__('Tags', 'shared-files'); ?></a>

            <a href="<?php echo esc_url_raw( get_admin_url(null, './edit.php?post_type=shared_file&page=shared-files-categories-info') ) ?>"><?php echo esc_html__('Categories', 'shared-files'); ?></a>

            <span class="shared-files-admin-toolbar-divider"></span>

            <a class="shared-files-btn-alt" href="<?php echo esc_url_raw( get_admin_url(null, './options-general.php?page=shared-files') ) ?>"><?php echo esc_html__('Settings', 'shared-files'); ?></a>

            <?php $freemius_user = shared_files_fs()->get_user(); ?>

            <?php if ( $freemius_user ): ?>

              <a class="shared-files-btn-alt" href="<?php echo esc_url_raw( get_admin_url(null, './options-general.php?page=shared-files-account') ) ?>"><?php echo esc_html__('Account', 'shared-files'); ?></a>

            <?php endif; ?>

            <span class="shared-files-admin-toolbar-divider"></span>

            <a href="<?php echo esc_url_raw( get_admin_url(null, './edit.php?post_type=shared_file&page=shared-files-shortcodes') ) ?>"><?php echo esc_html__('Shortcodes', 'shared-files'); ?></a>

            <a class="shared-files-admin-toolbar-support" href="https://wordpress.org/support/plugin/shared-files/" target="_blank"><span><?php echo esc_html__('Support', 'shared-files'); ?></span><img src="<?php echo esc_url_raw( SHARED_FILES_URI ) ?>img/external-link-black.svg" class="shared-files-external-link-icon" /></a>
        ...
        <div class="shared-files-admin-toolbar-right">
          ...
          <a href="https://www.sharedfilespro.com/pricing/?utm_source=Shared+Files+Free&utm_medium=toolbar-button-trial" target="_blank">
            <?php echo esc_html__( 'Start a Free Trial of Shared Files PRO', 'shared-files' ); ?> ➜
          </a>
