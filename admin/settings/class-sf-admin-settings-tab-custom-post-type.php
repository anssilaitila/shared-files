...
class SharedFilesSettingsTabCustomPostType {
  ...
  public function init() {
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-' . $only_pro . 'enable_single_file_page', 'field_name' => $only_pro . 'enable_single_file_page')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-' . $only_pro . 'show_files_in_site_search_results', 'field_name' => $only_pro . 'show_files_in_site_search_results')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-' . $only_pro . 'show_description_in_rest_api', 'field_name' => $only_pro . 'show_description_in_rest_api')
    );
    ...
    add_settings_field(
      ...
      'shared-files',
      'shared-files_tab_' . $tab,
      array('label_for' => 'shared-files-tag_slug', 'field_name' => 'tag_slug')
    );
